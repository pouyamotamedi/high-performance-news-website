...
class NewsApp {
  ...
  displaySearchSuggestions(suggestions, query) {
    ...
    const suggestionsList = suggestionsContainer?.querySelector('.header-suggestions-list');
    ...
    const html = suggestions.map(suggestion => `
      <li class="header-suggestion-item">
        <a href="/search?q=${encodeURIComponent(suggestion)}" class="header-suggestion-link">
