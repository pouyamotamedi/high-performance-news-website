...
var Translations = map[string]map[string]string{
	"en": {
		...
		"get_latest_articles": "Get the latest articles delivered to your inbox.",
	...
	"de": {
		...
		"get_latest_articles": "Erhalten Sie die neuesten Artikel in Ihrem Posteingang.",
	...
	"fr": {
		...
		"get_latest_articles": "Recevez les derniers articles dans votre boîte mail.",
	...
	"es": {
		...
		"get_latest_articles": "Recibe los últimos artículos en tu correo.",
		...
		"name":           "Nombre",
		"email":          "Email",
		"email_not_published": "Tu email no será publicado",
	...
	"ar": {
		...
		"get_latest_articles": "احصل على أحدث المقالات في بريدك الإلكتروني.",
		...
		"email_not_published": "لن يتم نشر بريدك الإلكتروني",
