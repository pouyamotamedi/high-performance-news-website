...
type AppConfig struct {
	...
	BaseURL     string `mapstructure:"base_url"` // Base URL for the website (e.g., https://example.com)
}
...
func setDefaults() {
	...
	viper.SetDefault("app.base_url", "") // Empty means auto-detect from request or use localhost
