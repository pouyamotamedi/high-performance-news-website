...
// SystemHealthCheck defines a health check function
...
func (fd *FailureDetector) registerDefaultHealthChecks() {
	...
	fd.checks = append(fd.checks, SystemHealthCheck{
...
func (fd *FailureDetector) checkDatabaseConnectivity() error {
	...
	// Example: Try to connect to PostgreSQL
...
func (fd *FailureDetector) checkCacheConnectivity() error {
	...
	// Example: Try to connect to cache
...
func (fd *FailureDetector) checkDiskSpace() error {
	...
	// Example disk space check would go here
	// stat, err := os.Stat(".")
	// if err != nil {
...
func (fd *FailureDetector) AddCustomHealthCheck(check SystemHealthCheck) {
