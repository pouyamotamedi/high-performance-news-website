...
func ValidateAllModels() error {
	...
	if err := ValidateSEOData(seoData); err != nil {
		return fmt.Errorf("SEO data validation failed: %w", err)
	}
	fmt.Println("✓ SEO Data validation passed")
...
func TestModelInteractions() error {
	...
	article := &Article{
		...
		SEOData: SEOData{
			...
			Keywords:        []string{"go", "web", "development"},
			SchemaType:      "NewsArticle",
		},
	}
