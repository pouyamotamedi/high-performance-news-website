...
func (w *PushNotificationWorker) GetWorkerStats() PushNotificationWorkerStats {
	return PushNotificationWorkerStats{
...
// PushNotificationWorkerStats contains statistics about the push notification worker
type PushNotificationWorkerStats struct {
