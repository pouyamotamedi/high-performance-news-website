...
func (s *SocialMediaJobScheduler) GetSocialMediaJobStats() (map[string]int, error) {
	stats := s.jobQueue.GetStats()
	
	// Filter stats for social media related jobs
	socialStats := map[string]int{
		"social_media_post":         0,
		"webhook_processing":        0,
		"facebook_instant_article":  0,
	}

	// This would need to be implemented based on your job queue's stats structure
